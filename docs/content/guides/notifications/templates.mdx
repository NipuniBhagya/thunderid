...
- For delivery, a configured [email provider](../email-providers) or [SMS provider](../sms-providers).
...
- [Configure an Email Provider](../email-providers): Connect the mail server that delivers your email templates
