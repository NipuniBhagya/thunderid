...
var (
	// SMTPSupportedAuthTypes lists the methods an SMTP email sender accepts.
	SMTPSupportedAuthTypes = []outboundauth.Type{outboundauth.TypeNone, outboundauth.TypeBasic}
)
