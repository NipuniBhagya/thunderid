...
// smtpConnectionRequest is the create/update payload for an SMTP email connection. Port and TLS
...
// smtpConnectionResponse is the detail payload for an SMTP email connection (secret masked).
