...
func registerRoutes(mux *http.ServeMux, h *handler) {
	...
	registerSenderVendorRoutes(mux, h, "/connections/"+emailSMTPVendorName, email, ncommon.NotificationProviderTypeSMTP,
		createSenderHandler(h, smtpToSenderDTO, smtpFromSenderDTO),
		getSenderHandler(h, email, ncommon.NotificationProviderTypeSMTP, smtpFromSenderDTO),
		updateSenderHandler(h, email, ncommon.NotificationProviderTypeSMTP, smtpToSenderDTO, smtpFromSenderDTO),
		collectionOpts, itemOpts)
}
